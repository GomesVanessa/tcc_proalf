            ...
            <Container>
                <AudioInstrucao controls />
                    <Wrapper>
                        ...
                        <CardClick></CardClick>
                        <CardClick>A</CardClick>
                        <CardClick>E</CardClick>
                        <CardClick>I</CardClick>
                        <CardClick>O</CardClick>
                        <CardClick>U</CardClick>
                        <CardClick>ÃO</CardClick> 
                        
                        <CardClick>F</CardClick>
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter0}
                                   onChange={validaLetter0} style={{outlineColor:color0,}}>
                            </input>
                        </CardClick>
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter1}
                                   onChange={validaLetter1} style={{outlineColor:color1,}}>
                            </input>
                        </CardClick>
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter2}
                                   onChange={validaLetter2} style={{outlineColor:color2,}}>
                            </input>
                        </CardClick>
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter3}
                                   onChange={validaLetter3} style={{outlineColor:color3,}}>
                            </input>
                        </CardClick>
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter4}
                                   onChange={validaLetter4} style={{outlineColor:color4,}}>
                            </input>
                        </CardClick>
                        <CardClick>
                            <input className= "3letter" type="text" maxLength="3" size="4" placeholder="_ _ _" value={letter5}
                                   onChange={validaLetter5} style={{outlineColor:color5,}}>
                            </input>
                        </CardClick>

                        <CardClick>J</CardClick>
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter6}
                                   onChange={validaLetter6} style={{outlineColor:color6,}}>
                            </input>
                        </CardClick>              
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter7}
                                   onChange={validaLetter7} style={{outlineColor:color7,}}>
                            </input>
                        </CardClick>
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter8}
                                   onChange={validaLetter8} style={{outlineColor:color8,}}>
                            </input>
                        </CardClick>
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter9}
                                   onChange={validaLetter9} style={{outlineColor:color9,}}>
                            </input>
                        </CardClick>
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter10}
                                   onChange={validaLetter10} style={{outlineColor:color10,}}>
                            </input>
                        </CardClick>
                        <CardClick>
                            <input type="text" maxLength="3" size="4" placeholder="_ _" value={letter11}
                                   onChange={validaLetter11} style={{outlineColor:color11,}}>
                            </input>
                        </CardClick>

                        <CardClick>M</CardClick>
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter12}
                                   onChange={validaLetter12} style={{outlineColor:color12,}}>
                            </input>
                        </CardClick>              
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter13}
                                   onChange={validaLetter13} style={{outlineColor:color13,}}>
                            </input>
                        </CardClick>
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter14}
                                   onChange={validaLetter14} style={{outlineColor:color14,}}>
                            </input>
                        </CardClick>
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter15}
                                   onChange={validaLetter15} style={{outlineColor:color15,}}>
                            </input>
                        </CardClick>
                        <CardClick>
                            <input type="text" maxLength="2" size="4" placeholder="_ _" value={letter16}
                                   onChange={validaLetter16} style={{outlineColor:color16,}}>
                            </input>
                        </CardClick>
                        <CardClick>
                            <input type="text" maxLength="3" size="4" placeholder="_ _" value={letter17}
                                   onChange={validaLetter17} style={{outlineColor:color17,}}>
                            </input>
                        </CardClick>             
                    </Wrapper>
                </Container>
            <Link to="/testReadFJM"><Button >Continuar</Button></Link>
        </Layout>    
    );
}
